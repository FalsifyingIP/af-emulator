...
#
# Configuration:
#   AF_PRIVATE_KEY  path to your locally supplied RSA private key (default: PRIVATE.PEM)
#   AF_LOG_PATH     server log path (default: af_server_live.log beside this file)
